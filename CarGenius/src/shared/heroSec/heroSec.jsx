    ...
    <div>
      ...
      <div  className="">
        <div className=" flex flex-col items-center p-20 py-30 gap-6 h-[700px] w-full bg-[#eef1fb]  " >
          ...
          <h2 className='text-center text-xl'> Find cars for sell and for rent near you</h2> <br />
          {/* <Search/> */}
          <img data-aos="fade-left" className='mt-10' src="https://i.ibb.co/ggqwYZR/slider51.png" alt="" width={1700} height={250} />
        </div>
      </div>
