        ...
        <>
            ...
            <div>
                <div className="lg:grid grid-cols-2 mx-20 m-10 gap-6">
                    ...
                    <a data-aos="fade-up-right" href="#" className="group relative block h-64 sm:h-80 lg:h-96 bg-blue-600" >
                    ...
                    <a data-aos="fade-up-left" className="group relative block h-64 sm:h-80 lg:h-96 bg-red-700">
                        <span className="absolute inset-0 border-2 border-dashed border-black"></span>
                        <div
                        ...
                        >
                            ...
                            <div
                                className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
                            >
                                <h3 className="mt-4 text-xl font-medium sm:text-2xl">Selling sec</h3>
                                ...
                                <br />
                                <Link to={"/sell_sec"}><Button className='bg-red-600 text-white w-40 h-11 text-lg hover:bg-red-500' variant=""> Get Started  <GoArrowUpRight className='m-3 text-2xl' /></Button> </Link>
