...
function    Card_section2() {
    return (
        <div>
            <section className="bg-[#eef1fb] text-black rounded-2xl" >
                <div className="max-w-screen-1xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 ">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
                        <div className="flex items-start gap-4">
                            <span className="shrink-0 rounded-lg bg-[#4f46e5] text-white p-4">
                                <svg
                                    className="size-5"
                                    fill="none"
                                    stroke="currentColor"
